"""
bookstore/settings/base.py — спільні налаштування для всіх середовищ.
"""
import os
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # відразу після SecurityMiddleware
...
# WhiteNoise — gzip + кешування статики
